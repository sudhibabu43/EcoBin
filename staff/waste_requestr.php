...
<div class="col-sm-9 col-md-10 mt-5 text-center">
 <p class="bg-dark text-white p-2">Waste Request Details</p>
 <?php 
  $sql = "SELECT * FROM waste_request where confirm='0'and type='regular'"; 
    ...
    echo '<tbody>';
     while($row = $result->fetch_assoc()){
      ...
      echo '<tr>';
       ...
       echo '<td>';
        echo '<form action="edit_waste_req.php" class="d-inline" method="POST">';
